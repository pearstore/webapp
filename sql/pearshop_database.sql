...
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((SELECT AArtid FROM Artikel_Art WHERE AArt_Name = "CPU"), 100, 'Intel Core i5 8600k <br> Anzahl der Kerne: 6 <br> Anzahl der Threads: 6 <br> Max. Turbo-Taktfrequenz 4,30 GHz <br> Taktfrequenz: 4.30 GHz <br> Grundtaktfrequenz des Prozessors: 3,60 GHz <br> Cache: 9 MB Intel® Smart Cache <br> Bus-Taktfrequenz: 8 GT/', 'Intel Core i5 8600k', 50);
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((SELECT AArtid FROM Artikel_Art WHERE AArt_Name = "GPU"), 250, 'NVIDIA GeForce GTX 1050TI <br> Speichergroesse: 4GB <br> Boost-Talt: 1392MHz <br> Speichergeschwindigkeit: 7 GBit/s <br> Speichergroesse: DDR5 <br> Anschluesse: 1x DVI, 1x HDMI, 1x Display Port', 'Nvidia Geforce GTX1050Ti', 55);
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((SELECT AArtid FROM Artikel_Art WHERE AArt_Name = "CPU"), 400, 'Intel Core i7 7700K <br> CPU-Modell: Core i7-870 <br> CPU-Taktfrequenz: 3.7 GHz <br> CPU-Sockel: 1151 ', 'Intel Core i7 7700k', 20);
...
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((SELECT AArtid FROM Artikel_Art WHERE AArt_Name = "CPU"), 150, 'Intel Core i3 8100k <br> Prozessornummer: i3-8100 <br> Grundtaktfrequenz: 3.60 GHz <br> Bus-Taktfrequenz: 8GT/s ', 'Intel Core i3 8100k', 5);
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((SELECT AArtid FROM Artikel_Art WHERE AArt_Name = "GPU"), 780, 'NVIDIA GeForce RTX 3070 Ti Founders Edition <br> Speichergroesse: 8GB <br>  Speichergeschwindigkeit: GDDR6X <br> Anschluesse: HDMI, 3x DP', 'Nvidia Geforce RTX3070Ti', 7);
...
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((Select AArtid FROM Artikel_Art WHERE AArt_Name = "GPU"), 3000, "NVIDIA TITAN V Volta <br> RAM-Groesse: 12280MB <br> Anschluesse: 3x DP, 1xHDMI <br> ", "Nvidia Titan V", 3);
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((Select AArtid FROM Artikel_Art WHERE AArt_Name = "GPU"), 6072, "NVIDIA Quadro RTX 8000 <br> RAM-Groesse: 48GB <br> RAM-Typ: GDDR6 <br> Anschluesse: 4x DP, USB-C <br> GPU-Taktfrequenz: 1396 MHz", "Nvidia Quadro RTX 8000", 2);
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((Select AArtid FROM Artikel_Art WHERE AArt_Name = "GPU"), 950, "Radeon RX 6800 Gaming <br> Max. Speichergroesse: 16 GB <br> Speichertyp: GDDR6 <br> Max. Speicherbandbreite: Bis zu 512 GB/s", "AMD Radeon Rx 6800", 9);
INSERT INTO Artikel (AArtid, Preis, Beschreibung, Name, Menge) VALUES ((SELECT AArtid FROM Artikel_Art WHERE AArt_Name = "RAM"), 1285, "NVIDIA TITAN X <br> RAM-Groesse: 12280MB <br> Taktrate 1418MHz <br> Anschluesse: 3x DP, 1xHDMI <br> ", "Nvidia Titan X", 5);
